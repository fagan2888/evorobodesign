...
class Genotype(object):
    ...
    def __init__(self, orig_size_xyz):
    ...
    def add_network(self, network, num_consecutive_mutations=1):
...
class Population(object):
    ...
    def __init__(self, objective_dict, genotype, phenotype, pop_size, individuals=None, reset_ind_age=False, material_wide_phase_offset=False, seed=0):
        ...
        self.material_wide_phase_offset = material_wide_phase_offset
        self.seed = seed
